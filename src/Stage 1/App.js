...
class App extends Component {
  ...
  // this function is bound to App and invoked from EmployeeList
  selectEmployee(employee) {
    this.setState({ selectedEmployee: employee });
  }

  // do this because we are updating employees using methods on their class (not setState)
  // so a re-render doesn't necessarily trigger. therfore we'll just trigger it
  refresh() {
